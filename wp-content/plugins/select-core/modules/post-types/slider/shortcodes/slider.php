...
class Slider implements Lib\ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        if ($slider != "") {
	        ...
	        if ($slider_parallax == 'no' || (pitch_qode_options()->getOptionValue( 'paspartu' ) == 'yes' && pitch_qode_options()->getOptionValue( 'paspartu_on_top' ) == 'yes' && pitch_qode_options()->getOptionValue( 'paspartu_on_top_fixed' ) == 'no')) {
            ...
            if (isset($slider_meta['slider_thumbs'])) {
                ...
                if(pitch_qode_options()->getOptionValue( 'vertical_area' ) =='yes' && pitch_qode_options()->getOptionValue( 'paspartu' ) == 'yes') {
                    $slider_thumbs = 'no';
                }
            }
            ...
            if (pitch_qode_options()->getOptionValue( 'header_background_transparency_initial' ) != "1" && pitch_qode_options()->getOptionValue( 'header_background_transparency_initial' ) != "") {
            ...
            if (pitch_qode_options()->getOptionValue( 'navigation_button_height' ) != '') {
                $arrow_button_height = esc_attr(pitch_qode_options()->getOptionValue( 'navigation_button_height' ));
            }
            ...
            if (pitch_qode_options()->getOptionValue( 'enable_manu_item_border' ) == 'yes' && pitch_qode_options()->getOptionValue( 'menu_item_style' ) == 'large_item') {
                if (pitch_qode_options()->getOptionValue( 'menu_item_border_style' ) == 'all_borders') {
                    $large_menu_item_border = esc_attr(pitch_qode_options()->getOptionValue( 'menu_item_border_width' )) * 2;
                }
                if (pitch_qode_options()->getOptionValue( 'menu_item_border_style' ) == 'top_bottom_borders') {
                    $large_menu_item_border = esc_attr(pitch_qode_options()->getOptionValue( 'menu_item_border_width' )) * 2;
                }
                if (pitch_qode_options()->getOptionValue( 'menu_item_border_style' ) == 'bottom_border') {
                    $large_menu_item_border = esc_attr(pitch_qode_options()->getOptionValue( 'menu_item_border_width' ));
                }
            }
            ...
            if (pitch_qode_options()->getOptionValue( 'header_bottom_appearance' )) {
                switch (pitch_qode_options()->getOptionValue( 'header_bottom_appearance' )) {
                    case 'stick':
                        $logo_height = esc_attr(pitch_qode_options()->getOptionValue( 'logo_height' )) / 2;
                        break;
                    ...
                    case 'regular':
                    	if (pitch_qode_options()->getOptionValue( 'center_logo_image' ) == "yes"){
                        	...
                        	$logo_height = esc_attr(pitch_qode_options()->getOptionValue( 'logo_height' ));
                    	}
                    	break;
                    default:
                        $logo_height = esc_attr(pitch_qode_options()->getOptionValue( 'logo_height' ));
            ...
            if ((get_post_meta($page_id, "qode_header_color_transparency_per_page", true) !== "0") && (pitch_qode_options()->getOptionValue( 'header_background_transparency_initial' ) !== "0") && ((pitch_qode_options()->getOptionValue( 'paspartu' ) == 'no') || (pitch_qode_options()->getOptionValue( 'paspartu_on_top' ) == 'no')) && !$hide_sticky_header) {

                $header_height_padding = $header_height + $menu_bottom + $header_top;
                if ((pitch_qode_options()->getOptionValue( 'center_logo_image' ) == "yes" && pitch_qode_options()->getOptionValue( 'header_bottom_appearance' ) !== 'stick menu_bottom' && pitch_qode_options()->getOptionValue( 'header_bottom_appearance' ) !== 'stick_with_left_right_menu') || pitch_qode_options()->getOptionValue( 'header_bottom_appearance' ) == "fixed_hiding") {
            ...
            $custom_cursor = "";
            if((pitch_qode_options()->getOptionValue( 'qs_enable_navigation_custom_cursor' )=="yes")){
                $custom_cursor = "has_custom_cursor";
            }

            if((pitch_qode_options()->getOptionValue( 'paspartu' ) == 'yes' && (pitch_qode_options()->getOptionValue( 'paspartu_on_top' ) == 'yes' && pitch_qode_options()->getOptionValue( 'paspartu_on_top_fixed' ) == 'no')) || $slider_parallax == "no"){
            ...
            if(pitch_qode_options()->getOptionValue( 'loading_animation' ) == "on") {
                if(pitch_qode_options()->getOptionValue( 'loading_image' ) != "") {
                    $ajax_loader = '<div class="ajax_loader" ' . $loader_margin_top . '><div class="ajax_loader_1"><div class="ajax_loader_2"><img src="' . esc_url(pitch_qode_options()->getOptionValue( 'loading_image' )) . '" alt="" /></div></div></div>';
                }else{
                    $ajax_loader = '<div class="ajax_loader" ' . $loader_margin_top . '><div class="ajax_loader_1">' . pitch_qode_loading_spinners(true) . '</div></div>';
                }
            }

            $html .= '<div id="qode-' . esc_attr($slider) . '" ' . $anchor_data . ' ' . $responsiveness_data . ' ' . $responsive_coefficients_graphic_data . ' ' . $responsive_coefficients_title_data . ' ' . $responsive_coefficients_subtitle_data . ' ' . $responsive_coefficients_text_data . ' ' . $responsive_coefficients_button_data . ' class="carousel slide ' . esc_attr($animation_type_class . ' ' . $custom_cursor . ' ' . $full_screen_class . ' ' . $responsive_height_class . ' ' . $height_class . ' ' . $auto_start_class . ' ' . $header_effect_class . ' ' . $slider_numbers_class .  ' ' . $slider_thumbs_class . ' ' . $slider_transparency_class . ' ' . $navigation_position_class . ' ' . $content_next_to_arrows_class) . '" ' . $slide_animation . ' ' . $data_height . ' ' . $data_parallax_effect . ' '.pitch_qode_get_inline_style($slide_holder_height. $background_color).'><div class="qode_slider_preloader" '.pitch_qode_get_inline_style($background_color).'>'.$ajax_loader.'</div>';
            $html .= '<div class="carousel-inner ' . esc_attr($slider_css_position_class) . '" '.pitch_qode_get_inline_style($carouselinner_height).' '.$data_parallax_transform.'>';
            ...
            if ($query_loop->have_posts()) : $postCount = 0;
                while ($query_loop->have_posts()) : $query_loop->the_post();
                    ...
                    $thumbnail_attributes = pitch_qode_get_attachment_meta_from_url($thumbnail, array('width','height'));
                    ...
                    if (get_post_meta(get_the_ID(), 'qode_slide-title-background-color', true) !== '') {
                        ...
                        $slide_title_span_style .= 'background-color: ' . esc_attr(pitch_qode_rgba_color($slide_title_bg_color, $slide_title_bg_transparency)) . ';';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-separator-title", true) == 'yes') {
                        ...
                        if ($slide_separator_type_var == "without_icon") {
                            ...
                            if ($slide_separator_color !== '') {
                                ...
                                if ($slide_separator_transparency !== '') {
                                    ...
                                    $slide_separator_rgba_color = pitch_qode_rgba_color($slide_separator_color, $slide_separator_transparency);
                        ...
                        if (get_post_meta(get_the_ID(), "qode_slide_title_separator_type", true) == "with_icon") {
                            ...
                            if (get_post_meta(get_the_ID(), "qode_slide_title_separator_with_icon_icon_pack", true) != ''){
                                ...
                                $slide_separator_icon_param = pitch_qode_icon_collections()->getIconCollection($slide_separator_icon);
                    ...
                    if (get_post_meta(get_the_ID(), 'qode_slide-subtitle-background-color', true) !== '') {
                        ...
                        $slide_subtitle_span_style .= 'background-color: ' . esc_attr(pitch_qode_rgba_color($slide_subtitle_bg_color, $slide_subtitle_bg_transparency)) . ';';
                    }
                    ...
                    if ($slide_text_separator_var == "no") {
                        ...
                        if (get_post_meta(get_the_ID(), 'qode_slide-text-background-color', true) !== '') {
                            ...
                            $slide_text_span_style .= 'background-color: ' . esc_attr(pitch_qode_rgba_color($slide_text_bg_color, $slide_text_bg_transparency)) . ';';
                        }
                    ...
                    if ($slide_type == 'video') {
                        ...
                        $html .= '<div class="video"><div class="mobile-video-image" '.pitch_qode_get_inline_style('background-image: url(' . esc_url($video_image) . ')').'></div><div class="video-overlay';
                        ...
                        $html .= '<div class="image" '.pitch_qode_get_inline_style('background-image:url(' . esc_url($image) . ')').'>';
                        if ($slider_thumbs == 'no') {
                            $html .= '<img src="' . esc_url($image) . '" alt="' . esc_attr($title) . '">';
                        }

                        if ($image_overlay_pattern !== "") {
                            $html .= '<div class="image_pattern" '.pitch_qode_get_inline_style('background: url(' . esc_url($image_overlay_pattern) . ') repeat 0 0').'></div>';
                        }
                        $html .= '</div>';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-subtitle", true) != "") {
                        ...
                        $html_text .= '<h3 class="q_slide_subtitle" '.pitch_qode_get_inline_style($slide_subtitle_style).'><span '.pitch_qode_get_inline_style($slide_subtitle_span_style).'>' . wp_kses_post(get_post_meta(get_the_ID(), 'qode_slide-subtitle', true)) . '</span></h3>';
                        $html_text .= '</div></div>';
                    }
                    ...
                    if ((get_post_meta(get_the_ID(), "qode_slide-separator-title", true) == 'yes') && ($slide_separator_position != 'bottom' ) && ($slide_separator_position) != 'left_right') {
                        ...
                        if (get_post_meta(get_the_ID(), 'qode_slide_title_separator_type', true) !== 'with_icon' && get_post_meta(get_the_ID(), 'qode_slide_title_separator_type', true) !== 'with_custom_icon') {
                            ...
                            $html_text .= '<div '.pitch_qode_get_inline_style($slide_separator_styles.$slide_top_separator_styles).' class="separator separator_top"></div>';
                            $html_text .= '</div></div>';
                        }
                        else {
                            $html_text .= '<div class="el">';
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-hide-title", true) != true) {
                        ...
                        $html_text .= '<h2 class="q_slide_title" '.pitch_qode_get_inline_style($slide_title_style).'>';
                        if ($slide_separator_position == 'left_right') {
                            $html_text .= '<span '.pitch_qode_get_inline_style($slide_separator_styles.$slide_left_separator_margin).' class="separator separator_left"><span class="slide_separator_dots" '.pitch_qode_get_inline_style($slide_dots_style).'></span></span>';
                        }
                        if (get_post_meta(get_the_ID(), "qode_slide-title-link", true) != '') {
                            $html_text .= '<a '.pitch_qode_get_inline_style($slide_title_style).' '.$slide_title_data.' href="' . esc_url(get_post_meta(get_the_ID(), "qode_slide-title-link", true)) . '" target="' . esc_attr(get_post_meta(get_the_ID(), "qode_slide-title-target", true)) . '">';
                        }
                        $html_text .= '<span '.pitch_qode_get_inline_style($slide_title_span_style).'>' . wp_kses_post(get_the_title()) . '</span>';
                        if (get_post_meta(get_the_ID(), "qode_slide-title-link", true) != '') {
                            $html_text .= '</a>';
                        }
                        if ($slide_separator_position == 'left_right') {
                            $html_text .= '<span '.pitch_qode_get_inline_style($slide_separator_styles.$slide_right_separator_margin).' class="separator separator_right"><span class="slide_separator_dots" '.pitch_qode_get_inline_style($slide_dots_style).'></span></span>';
                        }
                    ...
                    if ((get_post_meta(get_the_ID(), "qode_slide-separator-title", true) == 'yes') && ($slide_separator_position != 'top') && ($slide_separator_position) != 'left_right') {
                        ...
                        if (get_post_meta(get_the_ID(), 'qode_slide_title_separator_type', true) !== 'with_icon' && get_post_meta(get_the_ID(), 'qode_slide_title_separator_type', true) !== 'with_custom_icon') {
                            ...
                            $html_text .= '<div '.pitch_qode_get_inline_style($slide_separator_styles.$slide_bottom_separator_styles).'  class="separator separator_bottom"></div>';
                            $html_text .= '</div></div>';
                        }
                        else {
                            $html_text .= '<div class="el">';
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-text", true) != "") {
                        ...
                        if ($slide_text_separator_var == 'yes') {
                            ...
                            $html_text .= '<h3 class="q_slide_text" '.pitch_qode_get_inline_style($slide_text_style).'><span '.pitch_qode_get_inline_style($slide_text_span_style).'>' . wp_kses_post(get_post_meta(get_the_ID(), "qode_slide-text", true)) . '</span></h3>';
                        }
                        $html_text .= '</div></div>';
                    }
                    ...
                    if ($is_first_button_shown) {
                        ...
                        if(get_post_meta(get_the_ID(), 'button1_icon_pack', true) !== 'no_icon') {
                            $first_btn_icon_collection = pitch_qode_icon_collections()->getIconCollection(get_post_meta(get_the_ID(), 'button1_icon_pack', true));
                        ...
                        $html_text .= '<a class="qbutton '.esc_attr($first_button_icon_class) . esc_attr($first_button_class).'" ' . $data_attr1 . ' '.pitch_qode_get_inline_style($button_text_style1).' '.$slide_button_1_data.' href="' . esc_url(get_post_meta(get_the_ID(), "qode_slide-button-link", true)) . '" target="' . esc_attr($slide_button_target) . '"><span class="text_wrap">' . esc_html(get_post_meta(get_the_ID(), "qode_slide-button-label", true)) . '</span>' . $first_button_icon_html . $span .'</a>';
                    }
                    ...
                    if ($is_second_button_shown) {
                        ...
                        if(get_post_meta(get_the_ID(), 'button2_icon_pack', true) !== 'no_icon') {
                            $second_btn_icon_collection = pitch_qode_icon_collections()->getIconCollection(get_post_meta(get_the_ID(), 'button2_icon_pack', true));
                        ...
                        $html_text .= '<a class="qbutton '.esc_attr($second_button_icon_class) . esc_attr($second_button_class). '" ' . $data_attr2 . ' '.pitch_qode_get_inline_style($button_text_style2).' '.$slide_button_2_data.' href="' . esc_url(get_post_meta(get_the_ID(), "qode_slide-button-link2", true)) . '" target="' . esc_attr($slide_button_target2) . '"><span class="text_wrap">' . esc_html(get_post_meta(get_the_ID(), "qode_slide-button-label2", true)) . '</span>' . $second_button_icon_html . $span2 .  '</a>';
                    }
                    ...
                    if ($separate_text_graphic != 'yes') {
                        $html .= '<div class="slider_content ' . esc_attr($content_alignment) .'" '.pitch_qode_get_inline_style($content_width . $content_xaxis . $content_yaxis_start).' '.$slide_data_start.' '.$slide_data_end.' '.$slide_data_content_resize.'>';
							if(get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "yes"){
								$html .= '<div class="slider_content_inner ' . esc_attr($content_animation . ' ' . $content_animation_direction) .'" '.pitch_qode_get_inline_style($vertical_content_width . $vertical_content_xaxis . $slide_content_inner_shaddow . $slide_content_inner_background).'>';
							}
							$html .= $html_thumb;
							$html .= $html_text;
							if(get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "yes"){
                        ...
                        $html .= '<div class="slider_content graphic_content ' . esc_attr($graphic_alignment) . '" '.pitch_qode_get_inline_style($graphic_width . $graphic_xaxis . $graphic_yaxis_start).'>';
							if(get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "yes"){
								$html .= '<div class="slider_content_inner" '.pitch_qode_get_inline_style($vertical_content_width . $vertical_content_xaxis . $slide_content_inner_shaddow . $slide_content_inner_background).'>';
							}
							$html .= $html_thumb;
							if(get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "yes"){
								$html .= '</div>';
            ...
            if ($found_slides > 1) {
                if ($show_navigation_circles == "yes") {
                    ...
                    $triangle_bkg='';
                    if(pitch_qode_options()->getOptionValue( 'enable_slider_triangle' ) == 'yes') {
                ...
                if ($show_navigation_arrows == "yes") {
                    ...
                    if (pitch_qode_options()->getOptionValue( 'navigation_arrows_type' ) != '') {
                        $icon_navigation_class = pitch_qode_options()->getOptionValue( 'navigation_arrows_type' );
                    }
            ...
            $html .= '</div>';
            if(pitch_qode_options()->getOptionValue( 'paspartu' ) == 'yes' && pitch_qode_options()->getOptionValue( 'paspartu_on_bottom_slider' ) == 'yes') {
