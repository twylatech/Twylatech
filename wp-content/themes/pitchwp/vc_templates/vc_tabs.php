...
$output .= "\n\t\t\t" . $tabs_nav;
$output .= '<div class="tabs-container" '.pitch_qode_get_inline_style($tabs_container_style).'>';
$output .= "\n\t\t\t" . wpb_js_remove_wpautop($content);
$output .= "</div>";
if ('vc_tour' == $this->shortcode) {
    $output .= "\n\t\t\t" . '<div class="wpb_tour_next_prev_nav clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="' . esc_attr__('Previous slide', 'pitch') . '">' . esc_html__('Previous slide', 'pitch') . '</a></span> <span class="wpb_next_slide"><a href="#next" title="' . esc_html__('Next slide', 'pitch') . '">' . esc_html__('Next slide', 'pitch') . '</a></span></div>';
}
