...
if($type=="price_on_top" ){
    $html .= "<li class='prices' " .pitch_qode_get_inline_style($price_background_style) . ">";
    $html .= "<div class='price_in_table'" .  pitch_qode_get_inline_style($price_border_style).">";
    $html .= "<sup class='value' ".pitch_qode_get_inline_style($price_currency_style).">".$currency."</sup>";
    $html .= "<span class='price' ".pitch_qode_get_inline_style($price_style_array).">".$price."</span>";
    $html .= "<span class='mark'>/ ".$price_period."</span>";

    $html .= "</div>"; // close div.price_in_table
    $html .= "</li>"; //close li.prices
    $html .= "<li class='cell table_title ".$title_clasess."' ".pitch_qode_get_inline_style($title_holder_style).">";
    if($small_title != '') {
...
if($type=="title_on_top"){	
    ...
    $html .= "<li class='prices $pricing_content_clasess' " .pitch_qode_get_inline_style($price_background_style) . ">";
    $html .= "<div class='price_in_table'" .  pitch_qode_get_inline_style($price_border_style).">";
    $html .= "<sup class='value' ".pitch_qode_get_inline_style($price_currency_style).">".$currency."</sup>";
    $html .= "<span class='price' ".pitch_qode_get_inline_style($price_style_array).">".$price."</span>";
    $html .= "<span class='mark'>/ ".$price_period."</span>";
...
if($show_button == "yes"){
	if($pricing_button_type == "standard_button"){
		if(isset($button_text) && $button_text !== '') {
			$html .="<li class='price_button $button_class' ".pitch_qode_get_inline_style($button_holder_style)." >";
			if($type=="title_on_top"){
				$html .= "<div class='title_on_top_button_wrapper $disable_button_border_top_class'>";
				$html .= "<a ".pitch_qode_get_inline_style($button_style)." href='$link' target='$target'>".$button_text."";
				if($button_arrow == "yes"){
		...
		$html .="<a class='button_on_bottom' ".pitch_qode_get_inline_style($button_on_bottom_styles)." href='$link' target='$target'></a>";
		$html .="</li>";//close li.price_button
	}
}
