...
$html .= '<div class="vertical_split_slider_preloader" '.$qode_preloader_style.'><div class="ajax_loader"><div class="ajax_loader_1">'.pitch_qode_loading_spinners(true).'</div></div></div>';
