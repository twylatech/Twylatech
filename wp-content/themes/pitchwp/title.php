...
if(get_post_meta($qode_page_id, "qode_responsive-title-image", true) != ""){
 $responsive_title_image = get_post_meta($qode_page_id, "qode_responsive-title-image", true);
	...
	$responsive_title_image = pitch_qode_options()->getOptionValue( 'responsive_title_image' );
}
...
if(get_post_meta($qode_page_id, "qode_fixed-title-image", true) != ""){
 $fixed_title_image = get_post_meta($qode_page_id, "qode_fixed-title-image", true);
	...
	$fixed_title_image = pitch_qode_options()->getOptionValue( 'fixed_title_image' );
}
...
if(get_post_meta($qode_page_id, "qode_title-image", true) != ""){
    ...
    $title_image = pitch_qode_options()->getOptionValue( 'title_image' );
}
$title_image_height = "";
$title_image_width = "";
if($title_image !== ''){
	$title_image_dimensions_array = pitch_qode_get_image_dimensions($title_image);
...
elseif(pitch_qode_options()->getOptionValue( 'title_graphics' ) != "") {
    $title_graphics = pitch_qode_options()->getOptionValue( 'title_graphics' );
}
...
elseif (get_post_meta($qode_page_id, 'page_page_title_whole_content_animations', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_whole_content_animations' ) !== '') {
    $title_content_animation = pitch_qode_options()->getOptionValue( 'page_title_whole_content_animations' );
}
...
if ($title_content_animation == 'yes') {
    ...
    if (get_post_meta($qode_page_id, 'page_page_title_whole_content_data_start', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_whole_content_data_start' ) !== '') {
        $page_title_content_data_start = pitch_qode_options()->getOptionValue( 'page_title_whole_content_data_start' );
    ...
    if (get_post_meta($qode_page_id, 'page_page_title_whole_content_start_custom_style', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_whole_content_start_custom_style' ) !== '') {
        $page_title_content_start_custom_style = pitch_qode_options()->getOptionValue( 'page_title_whole_content_start_custom_style' );
    ...
    if (get_post_meta($qode_page_id, 'page_page_title_whole_content_data_end', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_whole_content_data_end' ) !== '') {
        $page_title_content_data_end = pitch_qode_options()->getOptionValue( 'page_title_whole_content_data_end' );
    ...
    if (get_post_meta($qode_page_id, 'page_page_title_whole_content_end_custom_style', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_whole_content_end_custom_style' ) !== '') {
        $page_title_content_end_custom_style = pitch_qode_options()->getOptionValue( 'page_title_whole_content_end_custom_style' );
...
elseif (get_post_meta($qode_page_id, 'page_page_title_graphic_animations', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_graphic_animations' ) !== '') {
    $graphic_animation = pitch_qode_options()->getOptionValue( 'page_title_graphic_animations' );
}
...
if ($title_graphics !== '' && $graphic_animation == 'yes'){
    ...
    if (get_post_meta($qode_page_id, 'page_page_title_graphic_data_start', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_graphic_data_start' ) !== '') {
        $page_title_graphic_data_start = pitch_qode_options()->getOptionValue( 'page_title_graphic_data_start' );
    ...
    if(get_post_meta($qode_page_id, 'page_page_title_graphic_start_custom_style', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_graphic_start_custom_style' ) !== '') {
        $page_title_graphic_start_custom_style = pitch_qode_options()->getOptionValue( 'page_title_graphic_start_custom_style' );
    ...
    if(get_post_meta($qode_page_id, 'page_page_title_graphic_data_end', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_graphic_data_end' ) !== '') {
        $page_title_graphic_data_end = pitch_qode_options()->getOptionValue( 'page_title_graphic_data_end' );
    ...
    if(get_post_meta($qode_page_id, 'page_page_title_graphic_end_custom_style', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_graphic_end_custom_style' ) !== '') {
        $page_title_graphic_end_custom_style = pitch_qode_options()->getOptionValue( 'page_title_graphic_end_custom_style' );
...
if(get_post_meta($qode_page_id, "qode_title-overlay-image", true) != ""){
 $title_overlay_image = get_post_meta($qode_page_id, "qode_title-overlay-image", true);
	...
	$title_overlay_image = pitch_qode_options()->getOptionValue( 'title_overlay_image' );
}
...
if(pitch_qode_options()->getOptionValue( 'enable_header_top_border' )=='yes' && pitch_qode_options()->getOptionValue( 'header_top_border_width' )!==''){
    $header_top_border = esc_attr(pitch_qode_options()->getOptionValue( 'header_top_border_width' ));
}
if(pitch_qode_options()->getOptionValue( 'enable_header_bottom_border' )=='yes' && pitch_qode_options()->getOptionValue( 'header_bottom_border_width' )!==''){
    $header_bottom_border = esc_attr(pitch_qode_options()->getOptionValue( 'header_bottom_border_width' ));
}

$header_centered_logo_border = 0;
if(pitch_qode_options()->getOptionValue( 'center_logo_image' ) == "yes" && pitch_qode_options()->getOptionValue( 'enable_border_top_bottom_menu' ) == "yes"){
    $header_centered_logo_border = 2;
}

$header_height = 90;
if (pitch_qode_options()->getOptionValue( 'header_height' )&& $header_bottom_appearance != "fixed_hiding") {
    $header_height = esc_attr(pitch_qode_options()->getOptionValue( 'header_height' ));
} elseif($header_bottom_appearance == "fixed_hiding"){
    $header_height = 90 + $logo_height/2 + 40; // 40 is top and bottom margin of logo
} elseif(pitch_qode_options()->getOptionValue( 'center_logo_image' ) == "yes" && $header_bottom_appearance == "fixed") {
...
if(pitch_qode_options()->getOptionValue( 'header_bottom_appearance' ) == 'stick menu_bottom'){
    $menu_bottom = 60;
...
if(pitch_qode_options()->getOptionValue( 'header_top_area' ) == "yes"){
	if(pitch_qode_options()->getOptionValue( 'header_top_height' ) !== ""){
		$header_top = pitch_qode_options()->getOptionValue( 'header_top_height' );
	} else {
		$header_top = 36;
	}
}
...
}elseif(get_post_meta($qode_page_id, "qode_page_page_title_vertical_aligment", true) == '' && (pitch_qode_options()->getOptionValue( 'page_title_vertical_aligment' ) == 'header_bottom')) {
	$title_vertical_alignment = 'header_bottom';
} elseif(get_post_meta($qode_page_id, "qode_page_page_title_vertical_aligment", true) == '' && (pitch_qode_options()->getOptionValue( 'page_title_vertical_aligment' ) == 'window_top')) {
	$title_vertical_alignment = 'window_top';
}
...
if (pitch_qode_options()->getOptionValue( 'header_height' )) {
    if($header_bottom_appearance == "fixed_hiding") {
        $header_height_padding =  esc_attr(pitch_qode_options()->getOptionValue( 'header_height' )) + $header_top + $logo_height/2 + 40 + $header_top_border + $header_bottom_border + $header_centered_logo_border; // 40 is top and bottom margin of logo
    } elseif(pitch_qode_options()->getOptionValue( 'center_logo_image' ) == "yes"){
        if($header_bottom_appearance == "fixed") {
            if (pitch_qode_options()->getOptionValue( 'header_height' ) > $logo_height) {
                $header_height_padding = esc_attr(pitch_qode_options()->getOptionValue( 'header_height' )) + $header_top + $logo_height + 20 + $header_top_border + $header_bottom_border + $header_centered_logo_border; // 20 is top margin of logo
            } else {
                $header_height_padding = (esc_attr(pitch_qode_options()->getOptionValue( 'header_height' ))) * 2 + $header_top + 20 + $header_top_border + $header_bottom_border + $header_centered_logo_border; // 20 is top margin of logo
            }
        }
        if($header_bottom_appearance == "stick"){
            $header_height_padding = (20 + $logo_height/2 + esc_attr(pitch_qode_options()->getOptionValue( 'header_height' )) + $header_top + $header_top_border + $header_bottom_border + $header_centered_logo_border); // 20 is top margin of centered logo
        }
    } else {
        if($header_bottom_appearance != "stick menu_bottom") {
            $header_height_padding = esc_attr(pitch_qode_options()->getOptionValue( 'header_height' )) + $header_top + $header_top_border + $header_bottom_border + $header_centered_logo_border;
        }
    }
}
...
if(get_post_meta($qode_page_id, "qode_page_title_type", true) != ""){
    ...
    if(pitch_qode_options()->getOptionValue( 'title_type' )){
...
if(get_post_meta($qode_page_id, "qode_page_subtitle_position", true) != ""){
    ...
    if(pitch_qode_options()->getOptionValue( 'subtitle_position' )){
        $subtitle_position = pitch_qode_options()->getOptionValue( 'subtitle_position' );
    }
}
...
} elseif(get_post_meta($qode_page_id, "qode_show-page-title", true) == '' && (pitch_qode_options()->getOptionValue( 'show_page_title' ) == 'yes')) {
	$is_title_area_visible = true;
} elseif(get_post_meta($qode_page_id, "qode_show-page-title", true) == '' && (pitch_qode_options()->getOptionValue( 'show_page_title' ) == 'no')) {
	$is_title_area_visible = false;
...
} elseif(get_post_meta($qode_page_id, "qode_show_page_title_text", true) == '' && (pitch_qode_options()->getOptionValue( 'show_page_title_text' ) == 'yes')) {
	$is_title_text_visible = true;
} elseif(get_post_meta($qode_page_id, "qode_show_page_title_text", true) == '' && (pitch_qode_options()->getOptionValue( 'show_page_title_text' ) == 'no')) {
	$is_title_text_visible = false;
...
elseif (get_post_meta($qode_page_id, 'page_page_title_animations', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_animations' ) !== '') {
    $title_animation = pitch_qode_options()->getOptionValue( 'page_title_animations' );
}
...
if($is_title_text_visible && $title_animation == 'yes') {
    ...
    if(get_post_meta($qode_page_id, 'page_page_title_data_start', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_data_start' ) !== '') {
        $page_title_data_start = pitch_qode_options()->getOptionValue( 'page_title_data_start' );
    ...
    if(get_post_meta($qode_page_id, 'page_page_title_start_custom_style', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_start_custom_style' ) !== '') {
        $page_title_start_custom_style = pitch_qode_options()->getOptionValue( 'page_title_start_custom_style' );
    ...
    if(get_post_meta($qode_page_id, 'page_page_title_data_end', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_data_end' ) !== '') {
        $page_title_data_end = pitch_qode_options()->getOptionValue( 'page_title_data_end' );
    ...
    if(get_post_meta($qode_page_id, 'page_page_title_end_custom_style', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_end_custom_style' ) !== '') {
        $page_title_end_custom_style = pitch_qode_options()->getOptionValue( 'page_title_end_custom_style' );
...
if(get_post_meta($qode_page_id, "qode_header_color_transparency_per_page", true) === "" || pitch_qode_is_archive_page()) {
...
if((pitch_qode_options()->getOptionValue( 'header_bottom_appearance' ) == "stick" || pitch_qode_options()->getOptionValue( 'header_bottom_appearance' ) == "stick menu_bottom" || pitch_qode_options()->getOptionValue( 'header_bottom_appearance' ) == "stick_with_left_right_menu")){
...
}elseif(pitch_qode_options()->getOptionValue( 'title_height' ) != ''){
	$title_height = esc_attr(pitch_qode_options()->getOptionValue( 'title_height' ));
}
//is header solid?
if(!$is_header_solid && !$is_header_initially_hidden && pitch_qode_options()->getOptionValue( 'header_bottom_appearance' ) != 'regular' && get_post_meta($qode_page_id, "qode_enable_content_top_margin", true) != "yes"){
...
if(get_post_meta($qode_page_id, "qode_page-title-background-color", true) != ""){
    ...
    $title_background_color = esc_attr(pitch_qode_options()->getOptionValue( 'title_background_color' ));
}
...
if(get_post_meta($qode_page_id, "qode_page_title_style", true) != ""){
    ...
    if(pitch_qode_options()->getOptionValue( 'title_style' )) {
        $qode_page_title_style = pitch_qode_options()->getOptionValue( 'title_style' );
    } else {
        $qode_page_title_style = "standard";
    }
}
...
if(get_post_meta($qode_page_id, "qode_animate_page_title", true) != ""){
    ...
    $animate_title_area = pitch_qode_options()->getOptionValue( 'animate_title_area' );
}
...
if(pitch_qode_is_side_header() && pitch_qode_options()->getOptionValue( 'paspartu' ) == 'no'){
    ...
    if(get_post_meta($qode_page_id, "qode_title-height", true) != ""){
        ...
        $title_height = esc_attr(get_post_meta($qode_page_id, "qode_title-height", true));
    }else if(pitch_qode_options()->getOptionValue( 'title_height' ) != ''){
        $title_holder_height = pitch_qode_options()->getOptionValue( 'title_height' );
        $title_height = esc_attr(pitch_qode_options()->getOptionValue( 'title_height' ));
    }
...
}elseif(pitch_qode_options()->getOptionValue( 'enable_breadcrumbs' )){
	$enable_breadcrumbs = pitch_qode_options()->getOptionValue( 'enable_breadcrumbs' );
}
...
elseif (get_post_meta($qode_page_id, 'page_page_title_breadcrumbs_animations', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_breadcrumbs_animations' ) !== '') {
    $breadcrumbs_animation = pitch_qode_options()->getOptionValue( 'page_title_breadcrumbs_animations' );
}
...
if($enable_breadcrumbs == 'yes' && $breadcrumbs_animation == 'yes') {
    ...
    if(get_post_meta($qode_page_id, 'page_page_title_breadcrumbs_data_start', true) == '' && (pitch_qode_options()->getOptionValue( 'page_title_breadcrumbs_data_start' ) !== '')) {
        $page_title_breadcrumbs_data_start = pitch_qode_options()->getOptionValue( 'page_title_breadcrumbs_data_start' );
    ...
    if(get_post_meta($qode_page_id, 'page_page_title_breadcrumbs_start_custom_style', true) == '' && (pitch_qode_options()->getOptionValue( 'page_title_breadcrumbs_start_custom_style' ) !== '')) {
        $page_title_breadcrumbs_start_custom_style = pitch_qode_options()->getOptionValue( 'page_title_breadcrumbs_start_custom_style' );
    ...
    if(get_post_meta($qode_page_id, 'page_page_title_breadcrumbs_data_end', true) == '' && (pitch_qode_options()->getOptionValue( 'page_title_breadcrumbs_data_end' ) !== '')) {
        $page_title_breadcrumbs_data_end = pitch_qode_options()->getOptionValue( 'page_title_breadcrumbs_data_end' );
    ...
    if(get_post_meta($qode_page_id, 'page_page_title_breadcrumbs_end_custom_style', true) == '' && (pitch_qode_options()->getOptionValue( 'page_title_breadcrumbs_end_custom_style' ) !== '')) {
        $page_title_breadcrumbs_end_custom_style = pitch_qode_options()->getOptionValue( 'page_title_breadcrumbs_end_custom_style' );
...
if(get_post_meta($qode_page_id, "qode_title_text_shadow", true) != ""){
	...
	if(pitch_qode_options()->getOptionValue( 'title_text_shadow' ) == "yes"){
		$title_text_shadow = ' title_text_shadow';
	}
}
$subtitle_color ="";
...
if ( is_home() && is_front_page() ) {
	...
	$title = single_term_title( '', false ) . esc_html__( ' Tag', 'pitch' );
} elseif ( is_date() ) {
	$title = get_the_time( 'F Y' );
} elseif ( is_author() ) {
	$title = esc_html__( 'Author: ', 'pitch' ) . get_the_author();
} elseif ( is_category() ) {
	$title = single_cat_title( '', false );
} elseif ( is_archive() ) {
	$title = esc_html__( 'Archive', 'pitch' );
} elseif ( is_search() ) {
	$title = esc_html__( 'Results for: ', 'pitch' ) . get_search_query();
} elseif ( is_404() ) {
	$title = pitch_qode_options()->getOptionValue( '404_title' ) ? pitch_qode_options()->getOptionValue( '404_title' ) : esc_html__( '404 - Page not found', 'pitch' );
}

if ( pitch_qode_is_woocommerce_shop() || is_singular( 'product' ) ) {
	$shop_id = pitch_qode_get_woo_shop_page_id();
	$title   = ! empty( $shop_id ) ? get_the_title( $shop_id ) : esc_html__( 'Shop', 'pitch' );
...
if (get_post_meta($qode_page_id,"qode_title_like_separator",true) == "yes" || (pitch_qode_options()->getOptionValue( 'title_like_separator' )=='yes' && get_post_meta($qode_page_id,"qode_title_like_separator",true) != "no")) {
...
if ($title_like_separator) {
    ...
    elseif (pitch_qode_options()->getOptionValue( 'page_title_position' )) {
        $title_shortcode .= ' text_position = "' . pitch_qode_options()->getOptionValue( 'page_title_position' ) . '"';
    }
    ...
    elseif (pitch_qode_options()->getOptionValue( 'title_like_separator_line_color' )) {
        $title_shortcode .= ' line_color = "' . pitch_qode_options()->getOptionValue( 'title_like_separator_line_color' ) . '"';
    }
    ...
    elseif (pitch_qode_options()->getOptionValue( 'title_like_separator_line_width' )) {
        $title_shortcode .= ' line_width = "' . pitch_qode_options()->getOptionValue( 'title_like_separator_line_width' ) . '"';
    }
    ...
    elseif (pitch_qode_options()->getOptionValue( 'title_like_separator_line_thickness' )) {
        $title_shortcode .= ' line_thickness = "' . pitch_qode_options()->getOptionValue( 'title_like_separator_line_thickness' ) . '"';
    }
    ...
    elseif (pitch_qode_options()->getOptionValue( 'title_like_separator_line_style' )) {
        $title_shortcode .= ' line_border_style = "' . pitch_qode_options()->getOptionValue( 'title_like_separator_line_style' ) . '"';
    }
    ...
    elseif (pitch_qode_options()->getOptionValue( 'title_like_separator_margins' )) {
        $title_shortcode .= ' box_margin = "' . pitch_qode_options()->getOptionValue( 'title_like_separator_margins' ) . '"';
    }
    ...
    elseif (pitch_qode_options()->getOptionValue( 'title_like_separator_line_dots' )) {
        $title_shortcode .= ' line_dots = "' . pitch_qode_options()->getOptionValue( 'title_like_separator_line_dots' ) . '"';
        if (pitch_qode_options()->getOptionValue( 'title_like_separator_line_dots' ) == "yes") {
            $title_like_separator_dots = true;
        }
    }
    ...
    if ($title_like_separator_dots) {          
        ...
        elseif (pitch_qode_options()->getOptionValue( 'title_like_separator_dots_size' )) {
            $title_shortcode .= ' line_dots_size = "' . pitch_qode_options()->getOptionValue( 'title_like_separator_dots_size' ) . '"';
        }
        ...
        elseif (pitch_qode_options()->getOptionValue( 'title_like_separator_dots_color' )) {
            $title_shortcode .= ' line_dots_color = "' . pitch_qode_options()->getOptionValue( 'title_like_separator_dots_color' ) . '"';
        }
    }
    ...
    if (get_post_meta($qode_page_id,'qode_title_background_color',true) != "") {
        $title_span_background_color_rgb = pitch_qode_hex2rgb(esc_attr(get_post_meta($qode_page_id, 'qode_title_background_color', true)));
    }
...
if (get_post_meta($qode_page_id,"qode_subtitle_like_separator",true) == "yes" || (pitch_qode_options()->getOptionValue( 'subtitle_like_separator' )=='yes' && get_post_meta($qode_page_id,"qode_subtitle_like_separator",true) != "no")) {
...
if ($subtitle_like_separator) {
    ...
    elseif (pitch_qode_options()->getOptionValue( 'page_title_position' )) {
        $subtitle_shortcode .= ' text_position = "' . pitch_qode_options()->getOptionValue( 'page_title_position' ) . '"';
    }
    ...
    elseif (pitch_qode_options()->getOptionValue( 'subtitle_like_separator_line_color' )) {
        $subtitle_shortcode .= ' line_color = "' . pitch_qode_options()->getOptionValue( 'subtitle_like_separator_line_color' ) . '"';
    }
    ...
    elseif (pitch_qode_options()->getOptionValue( 'subtitle_like_separator_line_width' )) {
        $subtitle_shortcode .= ' line_width = "' . pitch_qode_options()->getOptionValue( 'subtitle_like_separator_line_width' ) . '"';
    }
    ...
    elseif (pitch_qode_options()->getOptionValue( 'subtitle_like_separator_line_thickness' )) {
        $subtitle_shortcode .= ' line_thickness = "' . pitch_qode_options()->getOptionValue( 'subtitle_like_separator_line_thickness' ) . '"';
    }
    ...
    elseif (pitch_qode_options()->getOptionValue( 'subtitle_like_separator_line_style' )) {
        $subtitle_shortcode .= ' line_border_style = "' . pitch_qode_options()->getOptionValue( 'subtitle_like_separator_line_style' ) . '"';
    }
    ...
    elseif (pitch_qode_options()->getOptionValue( 'subtitle_like_separator_margins' )) {
        $subtitle_shortcode .= ' box_margin = "' . pitch_qode_options()->getOptionValue( 'subtitle_like_separator_margins' ) . '" ';
    }
    ...
    if (get_post_meta($qode_page_id,'qode_subtitle_background_color',true) != "") {
        $subtitle_span_background_color_rgb = pitch_qode_hex2rgb(esc_attr(get_post_meta($qode_page_id, 'qode_subtitle_background_color', true)));
    }
...
$separator_animation = '';
if (get_post_meta($qode_page_id,'qode_title_separator',true) == "yes"  || (pitch_qode_options()->getOptionValue( 'title_separator' )=='yes' && get_post_meta($qode_page_id,'qode_title_separator',true) != "no")) {
    $title_separator = "yes";
    ...
    elseif (pitch_qode_options()->getOptionValue( 'title_separator_position' ) == "above") {
        $title_separator_position_vertical = "above";
    }
    ...
    elseif (pitch_qode_options()->getOptionValue( 'title_separator_format' ) == "with_icon" || pitch_qode_options()->getOptionValue( 'title_separator_format' ) == "with_custom_icon") {
        $with_icon = true;
    }
    ...
    if ($with_icon) {
        ...
        if (get_post_meta($qode_page_id,'qode_title_separator_format',true) != "") {
            ...
            $separator_shortcode_params .= ' type = "' . pitch_qode_options()->getOptionValue( 'title_separator_format' ) . '" ';
        }

        if (get_post_meta($qode_page_id,'qode_title_separator_format',true) == "with_custom_icon" || (get_post_meta($qode_page_id,'qode_title_separator_format',true) == "" && pitch_qode_options()->getOptionValue( 'title_separator_format' ) == "with_custom_icon")) {
            ...
            elseif (pitch_qode_options()->getOptionValue( 'separator_custom_icon' )) {
                $separator_shortcode_params .= ' custom_icon ="' . pitch_qode_options()->getOptionValue( 'separator_custom_icon' ) . '" ';
            }
        }
        else {
            if (get_post_meta($qode_page_id,'qode_separator_icon_pack',true) != "") {
                $separator_shortcode_params .= pitch_qode_icon_collections()->iconPackParamName.'="'.get_post_meta($qode_page_id,'qode_separator_icon_pack',true).'"';

                $icon_collection = pitch_qode_icon_collections()->getIconCollection(get_post_meta($qode_page_id,'qode_separator_icon_pack',true));
            ...
            elseif (pitch_qode_options()->getOptionValue( 'separator_icon_pack' )) {

                $separator_shortcode_params .= pitch_qode_icon_collections()->iconPackParamName.'="'.pitch_qode_options()->getOptionValue( 'separator_icon_pack' ).'"';

                $icon_collection = pitch_qode_icon_collections()->getIconCollection(pitch_qode_options()->getOptionValue( 'separator_icon_pack' ));

                if(is_object($icon_collection) && pitch_qode_options()->getOptionValue( 'separator_icon_'.$icon_collection->param )) {
                    $separator_shortcode_params .= ' '.$icon_collection->param.'="'.pitch_qode_options()->getOptionValue( 'separator_icon_'.$icon_collection->param ).'"';
                }
            }
            ...
            elseif (pitch_qode_options()->getOptionValue( 'title_separator_icon_hover_color' )) {
                $separator_shortcode_params .= ' hover_icon_color = "'.pitch_qode_options()->getOptionValue( 'title_separator_icon_hover_color' ).'"';
            }
            ...
            elseif (pitch_qode_options()->getOptionValue( 'title_separator_icon_color' )) {
                $separator_shortcode_params .= ' icon_color = "'.pitch_qode_options()->getOptionValue( 'title_separator_icon_color' ).'"';
            }
            ...
            elseif (pitch_qode_options()->getOptionValue( 'title_separator_icon_custom_size' )) {
                $separator_shortcode_params .= ' icon_custom_size = "'.pitch_qode_options()->getOptionValue( 'title_separator_icon_custom_size' ).'"';
            }
            ...
            elseif (pitch_qode_options()->getOptionValue( 'title_separator_icon_type' )) {
                $separator_shortcode_params .= ' icon_type = "'.pitch_qode_options()->getOptionValue( 'title_separator_icon_type' ).'"';
                $separator_type = pitch_qode_options()->getOptionValue( 'title_separator_icon_type' );
            }
            ...
            if ($separator_type != "normal"){
                ...
                elseif (pitch_qode_options()->getOptionValue( 'title_separator_icon_border_radius' )) {
                    $separator_shortcode_params .= ' icon_border_radius = "'.pitch_qode_options()->getOptionValue( 'title_separator_icon_border_radius' ).'"';
                }
                ...
                elseif (pitch_qode_options()->getOptionValue( 'title_separator_icon_border_width' )) {
                    $separator_shortcode_params .= ' icon_border_width = "'.pitch_qode_options()->getOptionValue( 'title_separator_icon_border_width' ).'"';
                }
                ...
                elseif (pitch_qode_options()->getOptionValue( 'title_separator_icon_border_color' )) {
                    $separator_shortcode_params .= ' icon_border_color = "'.pitch_qode_options()->getOptionValue( 'title_separator_icon_border_color' ).'"';
                }
                ...
                elseif (pitch_qode_options()->getOptionValue( 'title_separator_icon_border_hover_color' )) {
                    $separator_shortcode_params .= ' hover_icon_border_color = "'.pitch_qode_options()->getOptionValue( 'title_separator_icon_border_hover_color' ).'"';
                }
                ...
                elseif (pitch_qode_options()->getOptionValue( 'title_separator_icon_shape_size' )) {
                    $separator_shortcode_params .= ' icon_shape_size = "'.pitch_qode_options()->getOptionValue( 'title_separator_icon_shape_size' ).'"';
                }
                ...
                elseif (pitch_qode_options()->getOptionValue( 'title_separator_icon_background_color' )) {
                    $separator_shortcode_params .= ' icon_background_color = "'.pitch_qode_options()->getOptionValue( 'title_separator_icon_background_color' ).'"';
                }
                ...
                elseif (pitch_qode_options()->getOptionValue( 'title_separator_icon_background_hover_color' )) {
                    $separator_shortcode_params .= ' hover_icon_background_color = "'.pitch_qode_options()->getOptionValue( 'title_separator_icon_background_hover_color' ).'"';
                }
            }
        }
        ...
        elseif (pitch_qode_options()->getOptionValue( 'title_separator_color' )) {
            $separator_shortcode_params .= ' color = "'.pitch_qode_options()->getOptionValue( 'title_separator_color' ).'"';
        }
        ...
        elseif (pitch_qode_options()->getOptionValue( 'title_separator_type' )) {
            $separator_shortcode_params .= ' border_style = "'.pitch_qode_options()->getOptionValue( 'title_separator_type' ).'"';
        }
        ...
        elseif (pitch_qode_options()->getOptionValue( 'title_separator_thickness' )) {
            $separator_shortcode_params .= ' thickness = "'.pitch_qode_options()->getOptionValue( 'title_separator_thickness' ).'"';
        }
        ...
        elseif (pitch_qode_options()->getOptionValue( 'title_separator_width' )) {
            $separator_shortcode_params .= ' width = "'.pitch_qode_options()->getOptionValue( 'title_separator_width' ).'"';
        }
        ...
        elseif (pitch_qode_options()->getOptionValue( 'title_separator_topmargin' )) {
            $separator_shortcode_params .= ' up = "'.pitch_qode_options()->getOptionValue( 'title_separator_topmargin' ).'"';
        }
        ...
        elseif (pitch_qode_options()->getOptionValue( 'title_separator_bottommargin' )) {
            $separator_shortcode_params .= ' down = "'.pitch_qode_options()->getOptionValue( 'title_separator_bottommargin' ).'"';
        }
        ...
        elseif (pitch_qode_options()->getOptionValue( 'title_separator_icon_position' )) {
            $separator_shortcode_params .= ' separator_icon_position = "'.pitch_qode_options()->getOptionValue( 'title_separator_icon_position' ).'"';
        }
        ...
        elseif (pitch_qode_options()->getOptionValue( 'title_separator_icon_margins' )) {
            $separator_shortcode_params .= ' icon_margin = "'.pitch_qode_options()->getOptionValue( 'title_separator_icon_margins' ).'"';
        }
    }
		...
		elseif(pitch_qode_options()->getOptionValue( 'page_title_position' )) {
			$separator_title_position = pitch_qode_options()->getOptionValue( 'page_title_position' );
		}
		...
		elseif(pitch_qode_options()->getOptionValue( 'title_separator_color' )){
			$title_separator_style .= 'border-color:'.esc_attr(pitch_qode_options()->getOptionValue( 'title_separator_color' )).';';
		}
		...
		elseif(pitch_qode_options()->getOptionValue( 'title_separator_thickness' )) {
			$title_separator_style .= 'border-width: ' . esc_attr(pitch_qode_options()->getOptionValue( 'title_separator_thickness' )) . 'px 0 0;';
		}
		...
		elseif(pitch_qode_options()->getOptionValue( 'title_separator_width' )) {
			$title_separator_style .= 'width: ' . esc_attr(pitch_qode_options()->getOptionValue( 'title_separator_width' )) . 'px;';
		}
		...
		elseif(pitch_qode_options()->getOptionValue( 'title_separator_topmargin' )) {
			$title_separator_style .= 'margin-top: ' . esc_attr(pitch_qode_options()->getOptionValue( 'title_separator_topmargin' )) . 'px;';
		}
		...
		elseif(pitch_qode_options()->getOptionValue( 'title_separator_bottommargin' )) {
			$title_separator_style .= 'margin-bottom: ' . esc_attr(pitch_qode_options()->getOptionValue( 'title_separator_bottommargin' )) . 'px;';
		}
		...
		elseif(pitch_qode_options()->getOptionValue( 'title_separator_type' )) {
			$title_separator_style .= 'border-style: ' . esc_attr(pitch_qode_options()->getOptionValue( 'title_separator_type' )) . ';';
		}
    }
    ...
    elseif(pitch_qode_options()->getOptionValue( 'page_title_separator_animations' ) && pitch_qode_options()->getOptionValue( 'page_title_separator_animations' ) !== '') {
        $separator_animation = pitch_qode_options()->getOptionValue( 'page_title_separator_animations' );
    }
    ...
    if($separator_animation == 'yes') {
        ...
        if(get_post_meta($qode_page_id, 'page_page_title_separator_data_start', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_separator_data_start' ) !== '') {
            $page_title_separator_data_start = pitch_qode_options()->getOptionValue( 'page_title_separator_data_start' );
        ...
        if(get_post_meta($qode_page_id, 'page_page_title_separator_start_custom_style', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_separator_start_custom_style' ) !== '') {
            $page_title_separator_start_custom_style = pitch_qode_options()->getOptionValue( 'page_title_separator_start_custom_style' );
        ...
        if(get_post_meta($qode_page_id, 'page_page_title_separator_data_end', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_separator_data_end' ) !== '') {
            $page_title_separator_data_end = pitch_qode_options()->getOptionValue( 'page_title_separator_data_end' );
        ...
        if(get_post_meta($qode_page_id, 'page_page_title_separator_end_custom_style', true) == '' && pitch_qode_options()->getOptionValue( 'page_title_separator_end_custom_style' ) !== '') {
            $page_title_separator_end_custom_style = pitch_qode_options()->getOptionValue( 'page_title_separator_end_custom_style' );
...
if (get_post_meta($qode_page_id,'qode_title_area_content_background_color',true) != "") {
    $title_area_content_background_color_rgb = pitch_qode_hex2rgb(esc_attr(get_post_meta($qode_page_id, 'qode_title_area_content_background_color', true)));
}
...
if (get_post_meta($qode_page_id,'qode_title_content_top_padding',true) != "") {
	$title_area_content_padding .= 'padding-top: ' . esc_attr(get_post_meta($qode_page_id,'qode_title_content_top_padding',true)). 'px; ';
}
if (get_post_meta($qode_page_id,'qode_title_content_right_padding',true) != "") {
	$title_area_content_padding .= 'padding-right: ' . esc_attr(get_post_meta($qode_page_id,'qode_title_content_right_padding',true)). 'px; ';
}
if (get_post_meta($qode_page_id,'qode_title_content_bottom_padding',true) != "") {
	$title_area_content_padding .= 'padding-bottom: ' . esc_attr(get_post_meta($qode_page_id,'qode_title_content_bottom_padding',true)). 'px; ';
}
if (get_post_meta($qode_page_id,'qode_title_content_left_padding',true) != "") {
	$title_area_content_padding .= 'padding-left: ' . esc_attr(get_post_meta($qode_page_id,'qode_title_content_left_padding',true)). 'px; ';
}
...
if (get_post_meta($qode_page_id, 'qode_page_subtitle', true) !== '') {
    ...
    elseif (pitch_qode_options()->getOptionValue( 'page_subtitle_animations' ) !== '') {
        $subtitle_animation = pitch_qode_options()->getOptionValue( 'page_subtitle_animations' );
    }
    ...
    if ($subtitle_animation == 'yes') {
        ...
        if(get_post_meta($qode_page_id, 'page_page_subtitle_data_start', true) == '' && (pitch_qode_options()->getOptionValue( 'page_subtitle_data_start' ) !== '')) {
            $page_subtitle_data_start = pitch_qode_options()->getOptionValue( 'page_subtitle_data_start' );
        ...
        if(get_post_meta($qode_page_id, 'page_page_subtitle_start_custom_style', true) == '' && (pitch_qode_options()->getOptionValue( 'page_subtitle_start_custom_style' ) !== '')) {
            $page_subtitle_start_custom_style = pitch_qode_options()->getOptionValue( 'page_subtitle_start_custom_style' );
        ...
        if(get_post_meta($qode_page_id, 'page_page_subtitle_data_end', true) == '' && (pitch_qode_options()->getOptionValue( 'page_subtitle_data_end' ) !== '')) {
            $page_subtitle_data_end = pitch_qode_options()->getOptionValue( 'page_subtitle_data_end' );
        ...
        if(get_post_meta($qode_page_id, 'page_page_subtitle_end_custom_style', true) == '' && (pitch_qode_options()->getOptionValue( 'page_subtitle_end_custom_style' ) !== '')) {
            $page_subtitle_end_custom_style = pitch_qode_options()->getOptionValue( 'page_subtitle_end_custom_style' );
...
if($is_title_area_visible) { ?>
	<div class="title_outer <?php echo esc_attr($animate_title_class.$title_text_shadow); if($responsive_title_image == 'yes' && $show_title_image == true && $title_image !== ''){ echo ' with_image'; }?>" <?php echo esc_attr($animation); ?> <?php echo 'data-height="'.esc_attr($title_height).'"'; if($title_height != '' && $animate_title_area == 'area_top_bottom'){ echo ' style="opacity:0; height:0px;"'; } ?>>
		<div class="title <?php pitch_qode_title_classes(); ?>" style="<?php if($responsive_title_image == 'no' && $title_image != "" && $show_title_image == true){ if($title_image_width != ''){ echo 'background-size:'.esc_attr($title_image_width).'px auto;'; } echo 'background-image:url('.esc_url($title_image).');';  } if($title_height != ''){ echo 'height:'.esc_attr($title_height).'px;'; } if($title_background_color != ''){ echo 'background-color:'.esc_attr($title_background_color).';'; } ?>">
			<div class="image <?php if($responsive_title_image == 'yes' && $title_image != "" && $show_title_image == true){ echo "responsive"; }else{ echo "not_responsive"; } ?>"><?php if($title_image != ""){ ?><img src="<?php echo esc_url($title_image); ?>" alt="<?php esc_attr_e( 'Title Image', 'pitch' ); ?>" /> <?php } ?></div>
			<?php if($title_overlay_image != ""){ ?>
				<div class="title_overlay" style="background-image:url('<?php echo esc_url($title_overlay_image); ?>');"></div>
			<?php } ?>

			<div class="title_holder" <?php echo pitch_qode_get_module_part( $page_title_content_animation_data ); ?> <?php if($responsive_title_image != 'yes'){ pitch_qode_inline_style($title_holder_height); } ?>>
				<div class="container clearfix">
					<div class="container_inner clearfix">
						<div class="title_subtitle_holder <?php echo esc_attr($title_content_classes); ?>" <?php if($title_image !== '' && $responsive_title_image == 'yes' && $show_title_image == true){ pitch_qode_inline_style($title_subtitle_padding); } if($title_content_classes !== ""){ pitch_qode_inline_style($title_area_style); } ?>>
							...
							<div class="title_subtitle_holder_inner title_content_background" <?php pitch_qode_inline_style($title_area_style); ?>>
							<?php } ?>
								<?php if($title_type != "breadcrumbs_title") { ?>

									<?php if($title_graphics != ""){ ?>
										<div class="title_graphics">
											<img src=<?php echo esc_url($title_graphics); ?> alt="<?php esc_attr_e( 'Title Graphic Image', 'pitch' ); ?>" class="title_graphics_img" <?php echo pitch_qode_get_module_part( $page_title_graphic_animation_data ); ?>>
										</div>
									<?php } ?>
									...
									<?php if($subtitle_position=="above_title"){?>
										<?php if(get_post_meta($qode_page_id, "qode_page_subtitle", true) != ""){ 
												if ($subtitle_like_separator){?>
												<span class="subtitle subtitle_like_separator <?php echo esc_attr($subtitle_in_box); ?>" <?php pitch_qode_inline_style($subtitle_color); ?>><span class="span_subtitle_separator" <?php echo pitch_qode_get_module_part( $page_subtitle_animation_data ); ?> > <?php echo do_shortcode($subtitle_shortcode); // XSS OK ?></span></span>
												<?php }
												else {
											?>
												<span class="subtitle" <?php pitch_qode_inline_style($subtitle_color); ?>><span <?php echo pitch_qode_get_module_part( $page_subtitle_animation_data ); ?> <?php pitch_qode_inline_style($subtitle_span_style); ?>><?php echo wp_kses_post(get_post_meta($qode_page_id, "qode_page_subtitle", true)); ?></span></span>
										<?php }
										} ?>
									<?php } ?>
                                    ...
                                    <?php if($title_separator == "yes" && $title_separator_position_vertical == "above"){
                                            if ($with_icon) {?>
                                                <div  <?php echo pitch_qode_get_module_part( $page_title_separator_animation_data ); ?>>
                                                <?php echo do_shortcode('[no_separator_with_icon '. $separator_shortcode_params .' ]'); // XSS OK ?>
                                                </div>
                                            <?php }
                                            else {?>
                                                <span class="separator small <?php echo esc_attr($separator_title_position); ?>" <?php pitch_qode_inline_style($title_separator_style); ?>  <?php echo pitch_qode_get_module_part( $page_title_separator_animation_data ); ?>></span>
                                            <?php } ?>
                                    <?php } ?>
                                    ...
                                    <?php if($is_title_text_visible) {
                                            if ($subtitle_position == "next_to_title" && get_post_meta($qode_page_id, "qode_page_subtitle", true) != ""){?>
                                                <h1 <?php echo pitch_qode_get_module_part( $page_title_animation_data ); if(get_post_meta($qode_page_id, "qode_page-title-color", true)) { ?> style="color:<?php echo esc_attr(get_post_meta($qode_page_id, "qode_page-title-color", true)); ?>" <?php } ?>><span <?php pitch_qode_inline_style($title_span_style); ?>><?php echo wp_kses_post($title); ?></span></h1>
                                                <span class="subtitle next_to_title" <?php pitch_qode_inline_style($subtitle_color); ?>><span <?php echo pitch_qode_get_module_part( $page_subtitle_animation_data ); ?> <?php pitch_qode_inline_style($subtitle_span_style); ?>><?php echo wp_kses_post(get_post_meta($qode_page_id, "qode_page_subtitle", true)); ?></span></span>
                                        <?php }
                                            else{
                                                if($title_like_separator){ ?>
                                                    <h1 class="title_like_separator <?php echo esc_attr($title_in_box); ?>" <?php echo pitch_qode_get_module_part( $page_title_animation_data ); if(get_post_meta($qode_page_id, "qode_page-title-color", true)) { ?> style="color:<?php echo esc_attr(get_post_meta($qode_page_id, "qode_page-title-color", true)); ?>" <?php } ?>><?php echo do_shortcode($title_shortcode); // XSS OK ?></h1>
                                            <?php }
                                                else {
                                            ?>
										          <h1 <?php echo pitch_qode_get_module_part( $page_title_animation_data ); if(get_post_meta($qode_page_id, "qode_page-title-color", true)) { ?> style="color:<?php echo esc_attr(get_post_meta($qode_page_id, "qode_page-title-color", true)); ?>" <?php } ?>><span <?php pitch_qode_inline_style($title_span_style); ?>><?php echo wp_kses_post($title); ?></span></h1>
								...
								<?php } ?>
									...
									<?php if (function_exists('pitch_qode_custom_breadcrumbs') && $enable_breadcrumbs == "yes") { ?>
										<div class="breadcrumb" <?php echo pitch_qode_get_module_part( $page_title_breadcrumbs_animation_data ); ?>> <?php pitch_qode_custom_breadcrumbs(); ?></div>
									<?php } ?>
