...
if (pitch_qode_options()->getOptionValue( 'blog_standard_type_read_more_button' )) {
    $blog_show_read_more_button = pitch_qode_options()->getOptionValue( 'blog_standard_type_read_more_button' );
}
