...
if (pitch_qode_options()->getOptionValue( 'portfolio_text_follow' )) {
    $portfolio_text_follow = esc_attr(pitch_qode_options()->getOptionValue( 'portfolio_text_follow' ));
}
...
} elseif(pitch_qode_options()->getOptionValue( 'portfolio_columns_number' ) !== '') {
	$columns_number = 'v'.pitch_qode_options()->getOptionValue( 'portfolio_columns_number' );
}
							...
							switch ($portfolio_video_type){
								case "youtube": ?>
									<?php if($lightbox_video_single_project == "yes"){ ?>
										...
										?>
										<a class="lightbox_single_portfolio <?php echo esc_attr($columns_number); ?>" title="<?php echo esc_attr($portfolio_image['portfoliotitle']); ?>" href="https://www.youtube.com/watch?feature=player_embedded&v=<?php echo esc_attr($vidID); ?>" data-rel="prettyPhoto[single_pretty_photo]">
