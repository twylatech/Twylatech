...
$qode_enable_content_top_margin = new PitchQodeMetaField(
	"yesnosimple",
	"qode_enable_content_top_margin",
	"no",
	esc_html__( "Always put content below header", 'pitch' ),
	esc_html__( "Enabling this option always will put content below header ", 'pitch' )
);
$row1->addChild(
	"qode_enable_content_top_margin",
	$qode_enable_content_top_margin
...
$qode_page_vertical_area_transparency = new PitchQodeMetaField(
	...
	esc_html__( "Enabling this option will make Side Menu background transparent ", 'pitch' ),
	array(
		"no" => esc_html__( "No", 'pitch' ),
		"yes" => esc_html__( "Yes", 'pitch' )
	)
...
$qode_page_vertical_area_background = new PitchQodeMetaField(
	...
	esc_html__( "Choose a color for Side Menu background", 'pitch' )
);
$qodeLeftMenuArea->addChild(
	"qode_page_vertical_area_background",
	$qode_page_vertical_area_background
...
$qode_choose_blog_category = new PitchQodeMetaField(
	"selectblank",
	"qode_choose-blog-category",
	"",
	esc_html__( "Blog Category", 'pitch' ),
	esc_html__( "Choose category of posts to display (leave empty to display all categories)", 'pitch' ),
...
$qode_show_posts_per_page = new PitchQodeMetaField(
	"text",
	"qode_show-posts-per-page",
	"",
	esc_html__( "Number of Posts", 'pitch' ),
	esc_html__( "Enter the number of posts to display", 'pitch' ),
	array(),
	array( "col_width" => 3 )
);
$qodeBlog->addChild(
...
$qode_enable_page_comments = new PitchQodeMetaField(
	"yesno",
	"qode_enable-page-comments",
	"no",
	esc_html__( "Show Comments", 'pitch' ),
	esc_html__( "Enabling this option will show comments on your page ", 'pitch' )
);
$qodeBlog->addChild(
	"qode_enable-page-comments",
...
$qodeFullScreenTemplate = new QodePitchMetaBox(
	"page",
	esc_html__( "Full Screen Template", 'pitch' )
);
$pitch_qode_framework->qodeMetaBoxes->addMetaBox(
...
$qode_full_screen_sections_on_small_screens = new PitchQodeMetaField(
	"selectblank",
