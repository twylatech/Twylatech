...
$qode_custom_sidebars = pitch_qode_get_custom_sidebars();
...
$qode_hide_featured_image = new PitchQodeMetaField(
	"yesno",
	"qode_hide-featured-image",
	"no",
	esc_html__( "Hide Featured image", 'pitch' ),
	esc_html__( "Do you want to hide featured image for this post?", 'pitch' )
);
$qodeGeneral->addChild(
	"qode_hide-featured-image",
...
$subtitle_padding_group = new PitchQodeGroup(
	esc_html__( "Padding", 'pitch' ),
	esc_html__( "Define padding for subtitle (When using separator around subtitle, only right margin is counted for left/right margin)", 'pitch' )
);
$qode_page_title_area_container->addChild(
...
$qodeLinkPostFormat = new QodePitchMetaBox(
	"post",
	esc_html__( "Link Post Format", 'pitch' )
);
$pitch_qode_framework->qodeMetaBoxes->addMetaBox(
	"post-format-link",
	$qodeLinkPostFormat
...
$qodeQuotePostFormat = new QodePitchMetaBox(
	"post",
	esc_html__( "Quote Post Format", 'pitch' )
);
$pitch_qode_framework->qodeMetaBoxes->addMetaBox(
	"post-format-quote",
	$qodeQuotePostFormat
...
$quote_format = new PitchQodeMetaField(
	"text",
	"quote_format",
	"",
	esc_html__( "Quote", 'pitch' ),
	esc_html__( "Enter Quote", 'pitch' )
);
...
$qodeAudioPostFormat = new QodePitchMetaBox(
	"post",
	esc_html__( "Audio Post Format", 'pitch' )
);
$pitch_qode_framework->qodeMetaBoxes->addMetaBox(
	"post-format-audio",
	$qodeAudioPostFormat
...
$audio_link = new PitchQodeMetaField(
	"text",
	"audio_link",
	"",
	esc_html__( "Link", 'pitch' ),
	esc_html__( "Enter audion link", 'pitch' )
);
...
$qodeGalleryPostFormat = new QodePitchMetaBox(
	"post",
	esc_html__( "Gallery Post Format", 'pitch' )
);
$pitch_qode_framework->qodeMetaBoxes->addMetaBox(
	"post-format-gallery",
	$qodeGalleryPostFormat
);

$qode_post_image_gallery = new PitchQodeMultipleImages(
	"qode_post-image-gallery",
	esc_html__( "Gallery Images", 'pitch' ),
	esc_html__( "Choose your gallery images", 'pitch' )
);
$qodeGalleryPostFormat->addChild(
	"qode_post-image-gallery",
	$qode_post_image_gallery
);

$gallery_position = new PitchQodeMetaField(
	"select",
	"gallery_position",
	"above_post_content",
	esc_html__( "Gallery Position", 'pitch' ),
	esc_html__( "Choose gallery position on single post pages", 'pitch' ),
	array(
		"above_post_content" => esc_html__( "Above Post Content", 'pitch' ),
		"above_post_content_and_sidebar" => esc_html__( "Above Post Content and Sidebar", 'pitch' )
	)
);
$qodeGalleryPostFormat->addChild(
	"gallery_position",
...
$qodeVideoPostFormat = new QodePitchMetaBox(
	"post",
	esc_html__( "Video Post Format", 'pitch' )
);
$pitch_qode_framework->qodeMetaBoxes->addMetaBox(
	"post-format-video",
	$qodeVideoPostFormat
...
$video_format_choose = new PitchQodeMetaField(
	"select",
	"video_format_choose",
	"youtube",
	esc_html__( "Video Type", 'pitch' ),
	esc_html__( "Choose video type", 'pitch' ),
	array(
		"youtube" => esc_html__( "Youtube", 'pitch' ),
		"vimeo" => esc_html__( "Vimeo", 'pitch' ),
		"self" => esc_html__( "Self Hosted", 'pitch' )
	),
	array(
		"dependence" => true,
		"hide"       => array(
...
$video_y_and_v_container = new PitchQodeContainer(
...
$video_self_hosted_container = new PitchQodeContainer(
...
$video_format_link = new PitchQodeMetaField(
	"text",
	"video_format_link",
	"",
	esc_html__( "Video ID", 'pitch' ),
	esc_html__( "Enter Video ID", 'pitch' )
);
...
$video_format_image = new PitchQodeMetaField(
	"image",
	"video_format_image",
	"",
	esc_html__( "Video Image", 'pitch' ),
	esc_html__( "Upload video image", 'pitch' )
);
...
$video_format_webm = new PitchQodeMetaField(
	"text",
	"video_format_webm",
	"",
	esc_html__( "Video webm", 'pitch' ),
	esc_html__( "Enter video URL", 'pitch' )
);
$video_self_hosted_container->addChild(
	"video_format_webm",
	$video_format_webm
...
$video_format_mp4 = new PitchQodeMetaField(
	"text",
	"video_format_mp4",
	"",
...
$video_format_ogv = new PitchQodeMetaField(
	"text",
	"video_format_ogv",
	"",
