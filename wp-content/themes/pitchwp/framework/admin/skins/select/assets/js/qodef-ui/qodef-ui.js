(function($){
    ...
    function qodeChangedInput () {
        $('.qodef-tabs-content').on('change keyup keydown', 'input:not([type="submit"]), textarea, select:not(#qodef-select-anchor)', function () {
    ...
    function qodefInitRangeSlider() {
    	var rangeHolder = $('.qodef-slider-range');
        if(rangeHolder.length) {
	        rangeHolder.each(function() {
        ...
        wp.media.customlibEditGallery1 = {
            frame: function() {
                ...
                this._frame.on('update', function() {
	                ...
	                var data = {
		                action: 'pitch_qode_gallery_upload_get_images',
		                ids: ids,
		                post_name: $input_gallery_items.attr('name'),
		                upload_gallery_nonce: $('#pitch-qode-update-images_' + $input_gallery_items.attr('name')).val()
	                };
	...
	function qodeInitPortfolioItemAcc() {
		...
		$(document).on('click', '.qodef-toggle-all-item', function(event) {
			event.preventDefault();
			$('.qodef-portfolio-additional-item').each(function(){
    ...
    function qodefSetIdOnRemoveItem(portfolio,portfolio_number){
	...
	function qodeInitPortfolioMediaAcc() {
		...
		$(document).on('click','.qodef-toggle-all-media', function(event) {
			event.preventDefault();
			$('.qodef-portfolio-media').each(function(){
    ...
    function qodefInitPortfolioImagesVideosBox() {
        ...
        $(document).on('change', 'select.qodef-portfoliovideotype', function() {
            qodefShowHidePorfolioImageVideoType();
        });
    }
    ...
    function qodefSetIdOnRemoveMedia(portfolio,portfolio_number){
    ...
    function qodefInitAjaxForm() {
        ...
        var b = $(this);
        var c = {
            action: "pitch_qode_action_save_options"
        };
        jQuery.ajax({
            url: ajaxurl,
            cache: !1,
