<div class="form-button-section clearfix">
    <div class="qodef-input-change"><?php esc_html_e( 'You should save your changes', 'pitch' ); ?></div>
    <div class="qodef-changes-saved"><?php esc_html_e( 'All your changes are successfully saved', 'pitch' ); ?></div>
        ...
        <div class="form-button-section-inner clearfix" >
            <?php if(is_array($page->layout) && count($page->layout)) { ?>
                <div class="qodef-anchors-holder">
                    <span class="qodef-page-anchors-label"><?php esc_html_e( 'Scroll to:', 'pitch' ); ?></span>
            ...
            <div class="qodef-form-save-holder">
                <input type="submit" class="btn btn-primary btn-sm pull-right" value="<?php esc_html_e('Save Changes', 'pitch'); ?>"/>
            </div>
        </div>
    </div>
</div>