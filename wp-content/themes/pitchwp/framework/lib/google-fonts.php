...
if ( ! function_exists( 'pitch_qode_init_google_fonts_array' ) ) {
	function pitch_qode_init_google_fonts_array() {
...
';
		...
		$pitch_fonts_array = $google_fonts_decoded['items'];
	}
	
	add_action('after_setup_theme', 'pitch_qode_init_google_fonts_array');
}