...
class PitchQodeFramework {
    ...
    private function __construct() {
        $this->qodeOptions = PitchQodeOptions::get_instance();
        $this->qodeMetaBoxes = PitchQodeMetaBoxes::get_instance();
    }
	...
	public function setSkin(PitchQodeSkinAbstract $skinObject) {
		$this->skin = $skinObject;
	}
}

/**
 * Class PitchQodeSkinManager
 *
...
class PitchQodeSkinManager {
    ...
    /**
     * @see PitchQodeSkinManager::setSkin()
     */
...
/**
 * Class PitchQodeSkinAbstract
 *
 * Abstract class that each skin class must extend
 */
abstract class PitchQodeSkinAbstract {
    /**
     * @var string
     */
    protected $skinName;
    ...
    public function getMenuIcon($icon) {
		...
		return PITCH_ROOT.'/img/favicon.ico';
	}
    ...
    public function setShortcodeJSParams() { ?>
		<script>
			window.qodeSCIcon = '<?php echo pitch_qode_get_skin_uri().'/assets/img/admin-logo-icon.png'; ?>';
...
class QodePitchAdminPage implements iLayoutNode {
    ...
    function __construct($slug="", $title_label="", $icon = "") {
        $this->layout = array();
        $this->factory = new PitchQodeFieldFactory();
        $this->slug = $slug;
...
class QodePitchMetaBox implements iLayoutNode {
	...
	public function setTitle($label) {
		...
		return $pitch_qode_framework->getSkin()->getSkinLabel().' '.$label;
 	}
}

if ( ! function_exists( 'pitch_qode_init_framework_variable' ) ) {
	function pitch_qode_init_framework_variable() {
		global $pitch_qode_framework;
		
		$pitch_qode_framework = PitchQodeFramework::get_instance();
		
		$qodeSkinManager = new PitchQodeSkinManager();
		$pitch_qode_framework->setSkin( $qodeSkinManager->getSkin() );
	}
	
	add_action( 'pitch_qode_action_before_options_map', 'pitch_qode_init_framework_variable' );
}