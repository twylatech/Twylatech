...
class PitchQodeCallToAction extends WP_Widget {
    public function __construct() {
		parent::__construct(
	 		'qode_call_to_action_widget', // Base ID
			esc_html__( 'Pitch Call To Action', 'pitch' ), // Name
			array( 'description' => esc_html__( 'Display a Call to Action element', 'pitch' ), ) // Args
		);
	}
    ...
    public function widget($args, $instance) {
 	...
 	public function form($instance) {
        ...
        $qode_icon_fields = pitch_qode_icon_collections()->getShortcodeParams();
        ...
        if(is_array(pitch_qode_icon_collections()->iconCollections) && count(pitch_qode_icon_collections()->iconCollections)) {
            ...
            $icon_collection_param = pitch_qode_icon_collections()->getIconCollectionsParams();

            foreach (pitch_qode_icon_collections()->iconCollections as $icon_collection_key => $icon_collection_obj) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'full_width' )); ?>"><?php esc_html_e( 'Full Width:','pitch'); ?></label>
            <select id="<?php echo esc_attr($this->get_field_id( 'full_width' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'full_width' )); ?>">
                <option value="yes" <?php if(esc_attr($full_width) == "yes"){echo 'selected="selected"';} ?>><?php esc_html_e('Yes', 'pitch') ?></option>
                <option value="no" <?php if(esc_attr($full_width) == "no"){echo 'selected="selected"';} ?>><?php esc_html_e('No', 'pitch') ?></option>
            </select>
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'content_in_grid' )); ?>"><?php esc_html_e( 'Content In Grid:','pitch'); ?></label>
            <select id="<?php echo esc_attr($this->get_field_id( 'content_in_grid' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'content_in_grid' )); ?>">
                <option value="yes" <?php if(esc_attr($content_in_grid) == "yes"){echo 'selected="selected"';} ?>><?php esc_html_e('Yes', 'pitch') ?></option>
                <option value="no" <?php if(esc_attr($content_in_grid) == "no"){echo 'selected="selected"';} ?>><?php esc_html_e('No', 'pitch') ?></option>
            </select>
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'grid_size' )); ?>"><?php esc_html_e( 'Grid Size:','pitch'); ?></label>
            <select id="<?php echo esc_attr($this->get_field_id( 'grid_size' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'grid_size' )); ?>">
                <option value="75" <?php if(esc_attr($grid_size) == "75"){echo 'selected="selected"';} ?>><?php esc_html_e('75/25', 'pitch') ?></option>
                <option value="50" <?php if(esc_attr($grid_size) == "50"){echo 'selected="selected"';} ?>><?php esc_html_e('50/50', 'pitch') ?></option>
                <option value="66" <?php if(esc_attr($grid_size) == "66"){echo 'selected="selected"';} ?>><?php esc_html_e('66', 'pitch') ?></option>
            </select>
        </p>
        
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'type' )); ?>"><?php esc_html_e( 'Type:','pitch'); ?></label>
            <select class="dependence" data-hide-with_icon="#<?php echo esc_attr($this->get_field_id('custom_icon')); ?>-container" data-show-with_icon="#<?php echo esc_attr($this->get_field_id( 'icon_pack' )); ?>-container, #<?php echo esc_attr($this->get_field_id('icon_size')); ?>-container" data-hide-normal="#<?php echo esc_attr($this->get_field_id( 'icon_pack' )); ?>-container,#<?php echo esc_attr($this->get_field_id('icon_size')); ?>-container, #<?php echo esc_attr($this->get_field_id('custom_icon')); ?>-container" data-show-with_custom_icon="#<?php echo esc_attr($this->get_field_id('icon_size')); ?>-container,#<?php echo esc_attr($this->get_field_id('custom_icon')); ?>-container" data-hide-with_custom_icon="#<?php echo esc_attr($this->get_field_id( 'icon_pack' )); ?>-container" id="<?php echo esc_attr($this->get_field_id( 'type' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'type' )); ?>">
                <option value="normal" ><?php esc_html_e('Normal', 'pitch') ?></option>
                <option value="with_icon" <?php if(esc_attr($type) == "with_icon"){echo 'selected="selected"';} ?>><?php esc_html_e('With Icon', 'pitch') ?></option>
                <option value="with_custom_icon" <?php if(esc_attr($type) == "with_custom_icon"){echo 'selected="selected"';} ?>><?php esc_html_e('With Custom Icon', 'pitch') ?></option>
            </select>
        </p>
        ...
        <div style="<?php if(!$icon_options_visible) { echo 'display: none;'; } ?>" id="<?php echo esc_attr($this->get_field_id( 'icon_pack' )); ?>-container">
            <p>
                <!--ICON PACK-->
                <label for="<?php echo esc_attr($this->get_field_id( 'icon_pack' )); ?>"><?php esc_html_e( 'Icon Pack:','pitch' ) ?></label>
                <select <?php echo pitch_qode_get_module_part( $icon_pack_data_attr_str ); ?> class="dependence" id="<?php echo esc_attr($this->get_field_id( 'icon_pack' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'icon_pack' )); ?>">
                    <?php

                    $icon_collections = pitch_qode_icon_collections()->getIconCollections();
            ...
            <?php if(is_array(pitch_qode_icon_collections()->iconCollections) && count(pitch_qode_icon_collections()->iconCollections)) { ?>

                <?php foreach(pitch_qode_icon_collections()->iconCollections as $key => $collection) {
                ...
                ?>
                    <p id="<?php echo esc_attr($this->get_field_id($collection->param));  ?>-container" style="<?php if(!$icon_pack_visible) { echo 'display: none;'; } ?>">
                        <label for="<?php echo esc_attr($this->get_field_id($collection->param)); ?>"><?php esc_html_e( 'Icon:','pitch' ) ?></label>
            ...
            <?php } ?>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'icon_position' )); ?>"><?php esc_html_e( 'Icon Position:','pitch'); ?></label>
                <select id="<?php echo esc_attr($this->get_field_id( 'icon_position' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'icon_position' )); ?>">
                    <option value="top" <?php if(esc_attr($icon_position) == "top"){echo 'selected="selected"';} ?>><?php esc_html_e('Default/Top', 'pitch') ?></option>
                    <option value="middle" <?php if(esc_attr($icon_position) == "middle"){echo 'selected="selected"';} ?>><?php esc_html_e('Middle', 'pitch') ?></option>
                    <option value="bottom" <?php if(esc_attr($icon_position) == "bottom"){echo 'selected="selected"';} ?>><?php esc_html_e('Bottom', 'pitch') ?></option>
                </select>
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'icon_color' )); ?>"><?php esc_html_e( 'Icon Color:','pitch' ) ?></label>
        ...
        <p style="<?php if($type !== 'with_custom_icon') { echo 'display: none;'; } ?>" id="<?php echo esc_attr($this->get_field_id('custom_icon')); ?>-container">
            <label for="<?php echo esc_attr($this->get_field_id( 'custom_icon' )); ?>"><?php esc_html_e( 'Custom Icon:','pitch' ) ?></label>
        ...
        <p style="<?php if(!in_array($type, array('with_icon', 'with_custom_icon'))) { echo 'display: none;'; } ?>" id="<?php echo esc_attr($this->get_field_id('icon_size')); ?>-container">
            <label for="<?php echo esc_attr($this->get_field_id( 'icon_size' )); ?>"><?php esc_html_e( 'Icon Size:','pitch' ) ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'background_color' )); ?>"><?php esc_html_e( 'Background Color:','pitch' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'border_color' )); ?>"><?php esc_html_e( 'Border Color:','pitch' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'box_padding' )); ?>"><?php esc_html_e( 'Box padding (top right bottom left) px', 'pitch' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_button' )); ?>"><?php esc_html_e( 'Show Button:','pitch'); ?></label>
            <select id="<?php echo esc_attr($this->get_field_id( 'show_button' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'show_button' )); ?>">
                <option value="yes" <?php if(esc_attr($show_button) == "yes"){echo 'selected="selected"';} ?>><?php esc_html_e('Yes', 'pitch') ?></option>
                <option value="no" <?php if(esc_attr($show_button) == "no"){echo 'selected="selected"';} ?>><?php esc_html_e('No', 'pitch') ?></option>
            </select>
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_position' )); ?>"><?php esc_html_e( 'Button position:','pitch'); ?></label>
            <select id="<?php echo esc_attr($this->get_field_id( 'button_position' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'button_position' )); ?>">
                <option value="right" <?php if(esc_attr($button_position) == "right"){echo 'selected="selected"';} ?>><?php esc_html_e('Right', 'pitch') ?></option>
                <option value="center" <?php if(esc_attr($button_position) == "center"){echo 'selected="selected"';} ?>><?php esc_html_e('Center', 'pitch') ?></option>
                <option value="left" <?php if(esc_attr($button_position) == "left"){echo 'selected="selected"';} ?>><?php esc_html_e('Left', 'pitch') ?></option>
            </select>
        </p>
        
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_size' )); ?>"><?php esc_html_e( 'Button Size', 'pitch' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_text' )); ?>"><?php esc_html_e( 'Button Text:','pitch' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'button_text' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'button_text' )); ?>" type="text" value="<?php echo esc_attr( $button_text ); ?>" />
        </p>
        
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_link' )); ?>"><?php esc_html_e( 'Button Link:','pitch' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_target' )); ?>"><?php esc_html_e( 'Button Target:','pitch' ); ?></label>
            <select id="<?php echo esc_attr($this->get_field_id( 'button_target' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'button_target' )); ?>">
                <option value="_blank" <?php if(esc_attr($button_target) == "_blank"){echo 'selected="selected"';} ?>><?php esc_html_e( 'Blank', 'pitch' ); ?></option>
                <option value="_self" <?php if(esc_attr($button_target) == "_self"){echo 'selected="selected"';} ?>><?php esc_html_e( 'Self', 'pitch' ); ?></option>
                <option value="_top" <?php if(esc_attr($button_target) == "_top"){echo 'selected="selected"';} ?>><?php esc_html_e( 'Top', 'pitch' ); ?></option>
                <option value="_parent" <?php if(esc_attr($button_target) == "_parent"){echo 'selected="selected"';} ?>><?php esc_html_e( 'Parent', 'pitch' ); ?></option>
            </select>
        </p>
        
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_text_color' )); ?>"><?php esc_html_e( 'Button Text Color:','pitch' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_hover_text_color' )); ?>"><?php esc_html_e( 'Button Hover Text Color:','pitch' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_background_color' )); ?>"><?php esc_html_e( 'Button Background Color:','pitch' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_hover_background_color' )); ?>"><?php esc_html_e( 'Button Hover Background Color:','pitch' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_border_color' )); ?>"><?php esc_html_e( 'Button Border Color:','pitch' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_hover_border_color' )); ?>"><?php esc_html_e( 'Button Hover Border Color:','pitch' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_border_width' )); ?>"><?php esc_html_e( 'Button Border Width', 'pitch' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'border_radius' )); ?>"><?php esc_html_e( 'Button Radius', 'pitch' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'text' )); ?>"><?php esc_html_e( 'Text:','pitch'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'text_color' )); ?>"><?php esc_html_e( 'Text Color:','pitch' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'text_size' )); ?>"><?php esc_html_e( 'Text Size:','pitch' ); ?></label>
