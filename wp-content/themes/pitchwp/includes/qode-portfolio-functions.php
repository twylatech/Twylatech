...
if(!function_exists('pitch_qode_get_portfolio_image_meta')) {
	function pitch_qode_get_portfolio_image_meta($image_src) {
		global $wpdb;
...
if (!function_exists('pitch_qode_compare_portfolio_images')) {
	/**
	 ...
	 */
	function pitch_qode_compare_portfolio_images($a, $b){
...
if (!function_exists('pitch_qode_compare_portfolio_options')){
	/**
	 ...
	 * @return int result of comparison
	 */
	function pitch_qode_compare_portfolio_options($a, $b){
